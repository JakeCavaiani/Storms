...
HI_FI_NO3$site.ID <- factor(HI_FI_NO3$site.ID, levels = c('FRCH','MOOS','CARI','POKE','STRT', 'VAUL'))
...
#### Correlation 
``` {r}
NO3_data <- HI_FI_NO3[,c("Hyst_index", "site.ID", "StormPrecip", "StormTemp", "PrecipWeek", "PrecipMonth", "ThreeMonth", "TempWeek", "Intensity", "TimeSinceChena", "pf", "burn")]
...
```{r}
aictab(list(M0,M1,M2,M3))
```
Mod3: Model without TempWeek, ThreeMonth, or StormTemp with a random intercept structure structure
...
``` {r}
fDOM_data <- HI_FI_fDOM[,c("Hyst_index", "site.ID", "StormPrecip", "StormTemp", "PrecipWeek", "PrecipMonth", "ThreeMonth", "TempWeek", "Intensity", "TimeSinceChena", "burn", "pf")]
...
f2.fDOM <- formula(Hyst_index ~ StormPrecip + PrecipWeek + PrecipMonth + Intensity + TempWeek + TimeSinceChena + (PrecipMonth|site.ID))
...
```{r}
aictab(list(M0.fDOM, M1.fDOM, M2.fDOM))

```
Mod2: Reduced model (no StormTemp or ThreeMonth precip) and random intercept structure
Mod3: Reduced model ('') with random slopes structure
...
``` {r}
SPC_data <- HI_FI_SPC[,c("Hyst_index", "site.ID", "StormPrecip", "StormTemp", "PrecipWeek", "PrecipMonth", "ThreeMonth", "TempWeek", "Intensity", "TimeSinceChena", "burn", "pf")]
...
```{r}
aictab(list(M0.SPC, M1.SPC, M2.SPC))
...
``` {r}
turb_data <- HI_FI_turb[,c("Hyst_index", "site.ID", "StormPrecip", "StormTemp", "PrecipWeek", "PrecipMonth", "ThreeMonth", "TempWeek", "Intensity", "TimeSinceChena", "burn", "pf")]
...
```{r}
aictab(list(M0.turb, M1.turb, M2.turb))
...
``` {r}
NO3_data_beta <- HI_FI_NO3[,c("beta", "site.ID", "StormPrecip", "StormTemp", "PrecipWeek", "PrecipMonth", "ThreeMonth", "TempWeek", "Intensity", "TimeSinceChena", "burn", "pf")]
